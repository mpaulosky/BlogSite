...
// File Name :     RuntimeEnvironment.cs
// Company :       mpaulosky
...
public static class RuntimeEnvironment
{
	...
	public static bool IsRunningInDevContainer()
	{
		...
		string? riderDev = Environment.GetEnvironmentVariable("RIDER_DEVCONTAINER");
		...
		string? inDev = Environment.GetEnvironmentVariable("IN_DEVCONTAINER");
